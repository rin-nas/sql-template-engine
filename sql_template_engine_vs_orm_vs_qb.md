...
## Выводы
1. ORM удобен работы с сущностями БД как объектами для очень простых действий: выборка/обновление/удаление записей в таблице с условием по первичному ключу, безусловная вставка записей в таблицу.
